...
export const CartProvider = ({ children }) => {
  ...
  const clearCart = () => {
    setCartItems([]); // Limpia todos los elementos del carrito
  };
  ...
  return (
    <CartContext.Provider value={{ cartItems, addToCart, removeItem, updateQuantity, totalItems, totalPrice, clearCart }}>
      {children}
