      ...
      >
        {categorias.map((categoria) => (
          <div
            ...
            className="flex items-center p-4 bg-gray-50 rounded-lg shadow-md hover:shadow-lg transition-shadow min-w-[200px] h-[100px] border border-gray-200"
          >
            <img
